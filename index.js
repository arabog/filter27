/*
Coding in function countGrade. function accept 1 parameters 
scores, it's a number array. Your task is to count the grade 
...
function countGrade(scores){
          return {
                    ...
                    'X': scores.filter( (x) => {return x == -1} ).length,
          };
}
